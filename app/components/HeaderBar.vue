...
<template>
    <header class="flex relative h-[100px] bg-[#1E1E1E] border-b border-[#F5F5F5] items-center justify-around z-10">
        ...
        <div class="flex justify-between items-center gap-5">
            <NuxtLink href="/favorite" class="flex text-[#B3B3B3] size-[50px] justify-center items-center hover:text-[#E55E00]">
            ...
            <NuxtLink href="/cart" class="flex relative text-[#B3B3B3] size-[50px] justify-center items-center hover:text-[#E55E00]">
