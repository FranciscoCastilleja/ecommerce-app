...
<template>
    <div v-for="product in data.products" class="group grid relative w-[280px] flex-shrink-0 border border-[#333333] place-items-center rounded-lg">
        <div class="relative w-[230px] overflow-hidden">
            ...
            <button class="flex absolute size-[38px] cursor-pointer text-[#B3B3B3] top-[10px] right-[10px] border-none rounded-full justify-center items-center hover:bg-[#ff4d4d] hover:text-white" title="Agregar a favoritos" @click="addFavorite(product.id)">
